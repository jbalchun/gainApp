...
app.controller('calendarcontrol', function ($scope, $ionicModal, $timeout, $ionicScrollDelegate,$ionicLoading, $rootScope, $localStorage, $state, localStore, $ionicPopup, $ionicPopover) {
    //$ionicLoading.show({
    //    template: 'loading'
    //});
