...
app.controller('NavCtrl', function($scope, $location, $state,$rootScope, Post) {//, Auth) {
    ...
    $scope.calendar = function(){
        ...
        console.log($rootScope.$storage.userId + ",went to Calendar")
    ...
    $scope.posts = function(){
        $state.go('tab.posts');
        console.log($rootScope.$storage.userId + ",went to Home")
        //cordova.plugins.Keyboard.hideKeyboardAccessoryBar(true);
    }
    ...
    $scope.charts = function(){
        ...
        if(window.cordova){
            ...
            console.log($rootScope.$storage.userId + ",went to Charts")
        }
    ...
    $scope.timerNav=function(){
        $state.go('tab.timer')
        console.log($rootScope.$storage.userId + ",went to Timer")
        //cordova.plugins.Keyboard.hideKeyboardAccessoryBar(true);
    }
