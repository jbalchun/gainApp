...
app.controller("chartcontrol", function ($scope, localStore, $ionicModal, $timeout, $rootScope, $ionicPopup, $ionicPopover, $state) {
    $scope.chartTable=0
    ...
    $scope.$on("$ionicView.beforeEnter", function (scopes, states) {
        console.log($scope.$storage.mainObj.nameList);
