...
app.factory('parseFactory', function ($rootScope, $localStorage,$timeout,$ionicHistory,$state) {
    return {
...
app.factory('QuickActionService', function ($rootScope, $localStorage,$q,$ionicHistory,$state) {
...
app.factory('localStore', function ($rootScope, $localStorage,$timeout,parseFactory) {
