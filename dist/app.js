...
app.run(["$ionicPlatform", "$timeout", "$state", "$localStorage", "$rootScope", "localStore", "$templateCache", "$ionicDeploy", "$ionicUser", "$ionicAnalytics", function ($ionicPlatform, $timeout, $state, $localStorage, $rootScope, localStore,$templateCache,$ionicDeploy,$ionicUser,$ionicAnalytics) {
