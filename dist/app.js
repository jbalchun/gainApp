...
app.run(["$ionicPlatform", "$timeout", "$ionicPopup", "$state", "$localStorage", "$http", "$rootScope", "localStore", "$templateCache", "$ionicDeploy", "$ionicUser", "$ionicAnalytics", "QuickActionService", function ($ionicPlatform, $timeout, $ionicPopup, $state, $localStorage, $http, $rootScope, localStore, $templateCache, $ionicDeploy, $ionicUser, $ionicAnalytics, QuickActionService) {
