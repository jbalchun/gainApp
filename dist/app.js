...
app.run(["$ionicPlatform", "$timeout", "$state", "$localStorage", "$rootScope", "localStore", "$templateCache", "$ionicDeploy", "$ionicAnalytics", function ($ionicPlatform, $timeout, $state, $localStorage, $rootScope, localStore,$templateCache,$ionicDeploy,$ionicAnalytics) {
