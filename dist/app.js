...
app.run(["$ionicPlatform", "$timeout", "$state", "$localStorage", "$rootScope", "localStore", "$templateCache", "$ionicDeploy", function ($ionicPlatform, $timeout, $state, $localStorage, $rootScope, localStore,$templateCache,$ionicDeploy) {
