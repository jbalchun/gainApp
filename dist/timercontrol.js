...
app.controller('timercontrol', ["$scope", "$ionicPopup", "$cordovaMedia", "$timeout", "$rootScope", "localStore", "$ionicPlatform", "$ionicPopover", "$cordovaLocalNotification", function($scope,$ionicPopup,$cordovaMedia,$timeout,$rootScope,localStore,$ionicPlatform,$ionicPopover,$cordovaLocalNotification) {
